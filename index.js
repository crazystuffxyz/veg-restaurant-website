...
let reviews = [ // Approved Reviews
    { id: 'initial1', name: 'Alice Garamasalachili', stars: 5, text: 'Absolutely loved the atmosphere and the food! The Salad was spectacular. Will definitely be back.', createdAt: moment().subtract(2, 'days').toISOString(), status: 'approved' },
