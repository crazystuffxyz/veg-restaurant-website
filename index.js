...
const RESTAURANT_PHONE = process.env.RESTAURANT_PHONE || '(703) 319-2700';
...
let reviews = [ // Approved Reviews
    ...
    { id: 'review-chen', name: 'Wei Chen', stars: 5, text: "A great experience. The Gourmet Avocado Toast and Simple Mixed Greens were absolutely divine. Great service.", createdAt: moment('2025-03-28').toISOString(), status: 'approved' },
